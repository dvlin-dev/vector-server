...
export const getKeyConfigurationFromEnvironment = (
  ...
  const keyConfiguration: KeyConfiguration = {
    ...
    embeddingApiKey: configService.get('EMBEDDING_API_KEY'),
    embeddingBaseUrl: configService.get('EMBEDDING_BASE_URL'),
    embeddingApiModel: configService.get('EMBEDDING_MODEL'),
  }
