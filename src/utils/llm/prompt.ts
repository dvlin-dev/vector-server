...
3. 你需要填中的只有{引导跳转的文案}、{sectionId}、{pageId}，其他的值都按照上面格式不要动，特别是单词不要写错了，例如格式中间的 pageId、sectionId
4. 正确示例：
...
首先，请仔细阅读以下板块内容和网站描述：
- sectionContent 为用户正在浏览的内容，代表他对这里感兴趣
- websiteDescription 是整个网站的信息描述
...
- 评估每个问题激发用户兴趣和互动的效果
- 确保问题涵盖网站内容的不同方面
- 确保问题与网站内容相关，通过网站的信息是可以把这个问题回答上来的。
